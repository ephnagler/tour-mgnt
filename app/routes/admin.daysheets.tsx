  ...
  export const meta: MetaFunction = () => [{ title: "Daysheet Admin - Suuns 2024" }];
  ...
  export default function AdminDaysheets() {
    ...
    const [selectedDaysheet, setSelectedDaysheet] = useState<{slug: string, date: string} | null>(null);
            ...
            <table className="table mt-0">
              <tbody>
                {data.daysheets.map((daysheet, index) => (
                  <tr
                    data-here={
                      location.pathname === `/admin/daysheets/${daysheet.slug}` ? true : false
                    }
                    ...
                    key={daysheet.id}
                    onClick={() => {
                      navigate(`/admin/daysheets/${daysheet.slug}?edit`, {
                        replace: true,
                      });
                    }}
                  >
