/*
  ...
  - You are about to drop the column `mapIn` on the `Daysheet` table. All the data in the column will be lost.
  - You are about to drop the column `mapOut` on the `Daysheet` table. All the data in the column will be lost.
...
INSERT INTO "new_Daysheet" ("buyOut", "buyOutAlt", "buyOutAmount", "date", "guestsLimit", "hotelId", "id", "slug", "venueId") SELECT "buyOut", "buyOutAlt", "buyOutAmount", "date", "guestsLimit", "hotelId", "id", "slug", "venueId" FROM "Daysheet";
DROP TABLE "Daysheet";
